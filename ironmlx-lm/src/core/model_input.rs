...
///
/// Common pattern used by both `Scheduler::step`
/// (per-row decode sampling) and `Scheduler::admit_mid`
...
///
/// **Production callers (B1-p2.3c-2):** `Scheduler::step`
...
pub fn log_vl_chunk_composition(
    path: &str,
...
pub fn extend_vl_chunk_end_for_image_pad(
    prompt_ids: &[u32],
    image_token_id: i32,
    chunk_start: i32,
    base_chunk_end: i32,
