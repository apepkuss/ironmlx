//! Model image configuration and preprocessing of decoded message parts.
...
impl VisionInputConfig {
    ...
    pub fn validate_image_input(&self) -> Result<(), crate::core::image_input::ImageInputError> {
...
pub type ExpandedVisionInputs = (
    Vec<PreparedTextMessage>,
    Option<Vec<Array>>,
    Vec<(i32, i32, i32)>,
);
...
pub fn expand_decoded_messages(
    ...
    let flat_messages: Vec<PreparedTextMessage> = messages
        .into_iter()
        .map(|msg| {
...
mod tests {
    ...
    fn expand_decoded_messages_interleaves_placeholders_in_part_order() {
        ...
        let img_bytes = std::fs::read(concat!(
            ...
            "/../ironmlx/tests/fixtures/qwen35_vl/coco_sample.jpg"
        ))
