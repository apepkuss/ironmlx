...
pub use drafter::Gemma4AssistantModel;
pub use drafter::{
...
pub use attention::SharedKv;
pub use config::Gemma4VisionRopeParams;
pub use drafter::{gemma4_shared_kv_from_cache_on, Gemma4DrafterStepOutput};
pub use text_model::Gemma4TextForwardOutput;
