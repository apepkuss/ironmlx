...
use ironmlx_lm::core::cache::gated_delta::GatedDeltaCache;
...
use {
    ironmlx_lm::nn::AttnKind, ironmlx_lm::nn::GatedDeltaNet, ironmlx_lm::nn::GatedDeltaNetConfig,
};
...
fn forward_route(
    ...
    let _position_stable = position_stable.then(ironmlx_lm::nn::position_stable_qmm_scope);
    let _sequence_stable = sequence_stable.then(ironmlx_lm::nn::sequence_stable_gated_delta_scope);
