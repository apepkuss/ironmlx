...
//!
//! Loads .npy fixtures from `tests/fixtures/gated_attention/` (generated
...
//!
//! ```text
//! cd ironmlx/tests/fixtures/gated_attention && python gen_fixture.py
//! ```

use mlx::{Array, Dtype};

use ironmlx_lm::nn::{GatedAttention, GatedAttentionConfig, Linear, Mrope, RmsNorm};

const FIXTURE_DIR: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../ironmlx/tests/fixtures/gated_attention"
);
