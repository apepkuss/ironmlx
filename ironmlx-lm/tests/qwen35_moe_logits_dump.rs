...
//!     cargo test -p ironmlx-lm --release --test qwen35_moe_logits_dump \
...
use ironmlx_lm::models::qwen3_5_moe::MIN_KV_CACHE_CAP_FOR_GPU_PERF;
...
fn write_npy_f32(path: &str, data: &[f32]) -> std::io::Result<()> {
    ...
    let pad_to = total_pre_pad.div_ceil(64) * 64;
