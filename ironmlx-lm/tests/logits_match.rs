...
//!   cargo test -p ironmlx-lm --test logits_match --release -- --ignored

use std::path::Path;

use mlx::Dtype;

use ironmlx_lm::core::model_input::{build_position_ids_vl, IMAGE_TOKEN_ID};
use ironmlx_lm::core::Loader;
use ironmlx_lm::models::qwen3_5::Qwen35Config;
use ironmlx_lm::models::qwen3_5::Qwen35Model;

const FIXTURE_DIR: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../ironmlx/tests/fixtures/qwen35_vl/multi_image"
);
