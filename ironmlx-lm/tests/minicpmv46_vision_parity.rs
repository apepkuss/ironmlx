...
//!   cargo test --release -p ironmlx-lm --test minicpmv46_vision_parity -- --ignored --nocapture
//! ```

use mlx::{ops, Array, Dtype};

use ironmlx_lm::core::Loader;
use ironmlx_lm::models::minicpmv4_6::config::MiniCpmV46VisionConfig;
use ironmlx_lm::models::minicpmv4_6::vision::MiniCpmV46Vision;
