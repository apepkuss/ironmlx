...
//!   cargo test --release -p ironmlx-lm --test minicpmv46_text_logits_match -- --ignored --nocapture
//! ```

use mlx::{Array, Dtype};

use ironmlx_lm::core::{model_input::build_position_ids, Loader, Model};
use ironmlx_lm::models::minicpmv4_6;
...
const FIXTURE_DIR: &str = concat!(
    ...
    "/../ironmlx/tests/fixtures/minicpmv46"
);
