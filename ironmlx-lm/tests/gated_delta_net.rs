...
//!
//! Loads .npy fixtures from `tests/fixtures/gated_delta_net/` (generated
...
//!
//! ```text
//! cd ironmlx/tests/fixtures/gated_delta_net && python gen_fixture.py
//! ```

use mlx::{Array, Dtype};

use ironmlx_lm::nn::{
    Conv1d, Conv1dConfig, GatedDeltaNet, GatedDeltaNetConfig, Linear, RmsNormGated,
};

const FIXTURE_DIR: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../ironmlx/tests/fixtures/gated_delta_net"
);
