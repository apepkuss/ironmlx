//! Runtime profile identity from native model and execution options.
...
pub struct SchedulerProfileContextOptions<'a> {
    ...
    pub ssd_prefix_cache_max_bytes: Option<usize>,
...
pub fn build_scheduler_runtime_context(
    model_dir: &Path,
...
mod tests {
    ...
    use super::{build_scheduler_runtime_context, SchedulerProfileContextOptions, StableHasher};
