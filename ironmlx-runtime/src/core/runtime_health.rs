//! Runtime model, scheduler and memory health snapshots.
...
pub struct MemoryInfo {
    ...
    pub immutable_prefix_blocks: crate::core::scheduler_actor::ImmutablePrefixBlockHealth,
}
...
pub struct SchedulerHealthCollector {
    ...
    pub immutable_prefix_blocks: crate::core::scheduler_actor::ImmutablePrefixBlockSharedStats,
}
...
mod tests {
    ...
    fn classify_healthy_when_all_green() {
        let governor = crate::core::process_memory::MemoryGovernorSnapshot {
    ...
    fn test_collector_with_active_kv(
        ...
        SchedulerHealthCollector {
            ...
            immutable_prefix_blocks:
                crate::core::scheduler_actor::ImmutablePrefixBlockSharedStats::new(false),
        }
    }
