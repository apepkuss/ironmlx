...
use ironmlx_lm::core::TokenizerConfig;
...
impl ironmlx_lm::core::Model for FakeMtpModel {
    fn make_cache(
        &self,
        _batch: i32,
        _cap: i32,
        _dtype: Dtype,
    ) -> ironmlx_runtime::Result<Vec<ironmlx_lm::core::cache::layer::LayerCache>> {
        Ok(Vec::new())
    }
...
impl MtpSpeculativeModel for FakeMtpModel {
    ...
    fn load_mtp_head(&self, _loader: &Loader) -> ironmlx_runtime::Result<Self::MtpHead> {
        Ok(FakeMtpHead)
    }
    ...
    fn make_mtp_cache(
        ...
        cap: i32,
        dtype: Dtype,
    ) -> ironmlx_runtime::Result<ironmlx_lm::core::cache::MtpCache> {
        ironmlx_lm::core::cache::MtpCache::new_with_cap(1, 1, 1, 1, 1, dtype, cap)
    }
    ...
    fn mtp_forward_hidden_on(
        ...
        _position_ids: &Array,
        _mask: Option<&Array>,
        mtp_cache: Option<&mut ironmlx_lm::core::cache::MtpCache>,
    ...
    fn mtp_forward_on(
    ...
    ) -> ironmlx_runtime::Result<ironmlx_lm::nn::MtpStepOutput> {
        ...
        flat[token] = 100.0;
        Ok(ironmlx_lm::nn::MtpStepOutput {
            hidden_states,
