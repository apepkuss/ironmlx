...
//!
//! Reference fixtures: `../ironmlx/tests/fixtures/qwen35_vl/multi_image/`.
//!
//! Run with:
//! ```text
//! QWEN35_MODEL=/path/to/Qwen3.5-4B-MLX-4bit \
//! MLX_DIR=$HOME/.local/mlx \
//! cargo test -p ironmlx-runtime --release --test batched_vl -- --ignored --test-threads=1 --nocapture
//! ```
...
use ironmlx_lm::models::qwen3_5::image_processor;
...
const FIXTURE_DIR: &str = "../ironmlx/tests/fixtures/qwen35_vl/multi_image";
