...
use ironmlx_runtime::core::scheduler::StepEvent;
use tokio::sync::{mpsc, Mutex};
use {
    ironmlx_core::sampler::Sampler, ironmlx_lm::core::loader::QuantMode,
...
use {
    ...
    ironmlx_lm::core::vision_input::expand_decoded_messages,
    ironmlx_lm::core::vision_input::DecodedMessage, ironmlx_lm::core::vision_input::DecodedPart,
};
use {ironmlx_lm::models::Gemma4Config, ironmlx_lm::models::Gemma4Model};
use {
    ironmlx_runtime::core::scheduler_actor::spawn_scheduler_actor,
    ironmlx_runtime::core::scheduler_actor::spawn_scheduler_actor_with_paged_prefix_cache_and_active_kv,
...
fn make_image_request(
    ...
    let prompt_ids = tokenizer
        .apply_chat_template(
            &flat_messages
                .iter()
                .map(|message| ironmlx_lm::core::tool_calling::AgentMessage {
        ...
        .and_then(|prompt| tokenizer.encode(&prompt, false))
        .expect("render Gemma4 image prompt");
    assert!(
        prompt_ids
            .iter()
