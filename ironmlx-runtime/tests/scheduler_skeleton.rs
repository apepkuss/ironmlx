...
//!
//! Run with:
//!   cargo test -p ironmlx-runtime --release --test scheduler_skeleton

use ironmlx_core::sampler::Sampler;
use ironmlx_runtime::core::generation_types::GenerateRequest;
use ironmlx_runtime::core::scheduler::RequestId;
...
fn b1_p2_3a_admit_evict_sequence() {
    let mut s = Scheduler::<ironmlx_lm::models::Qwen35Model>::new(
        4,
        32768,
