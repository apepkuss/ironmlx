...
//! generated fixtures from `../ironmlx/tests/fixtures/gemma4_long_context/gen_reference.py`.
...
use ironmlx_runtime::core::gemma4_generation::Gemma4DrafterGenerationStream;
use ironmlx_runtime::core::generate::GenerationStream;
use ironmlx_runtime::core::generation_types::GenerateRequest;
use ironmlx_runtime::core::scheduler::Scheduler;
...
const FIXTURE_DIR: &str = concat!(
    ...
    "/../ironmlx/tests/fixtures/gemma4_long_context"
);
...
fn record_scheduler_events(
    request_ids: &[ironmlx_runtime::core::scheduler::RequestId],
    outputs: &mut [Vec<u32>],
    finished: &mut [bool],
    events: Vec<ironmlx_runtime::core::scheduler::StepEvent>,
) -> Result<()> {
    for event in events {
        let row = request_ids
            .iter()
