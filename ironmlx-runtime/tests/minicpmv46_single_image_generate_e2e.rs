...
//! `../ironmlx/tests/fixtures/minicpmv46_vl/gen_single_image_generate.py` (gitignored .npy):
...
//!   cargo test --release -p ironmlx-runtime --test minicpmv46_single_image_generate_e2e -- --ignored --nocapture
//! ```
...
use ironmlx_lm::models::minicpmv4_6::model::MiniCpmV46Model;
