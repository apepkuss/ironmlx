...
use ironmlx_runtime::core::scheduler_autotune::build_scheduler_autotune_report;
use ironmlx_runtime::core::scheduler_autotune::prompt_batch_limits_for_model;
use ironmlx_runtime::core::scheduler_autotune::PromptBatchLimit;
use ironmlx_runtime::core::scheduler_autotune::SchedulerAutotuneInput;
...
impl Model for BatchLimitedModel {
    fn make_cache(
        ...
        _cap: i32,
        _dtype: Dtype,
    ) -> ironmlx_runtime::Result<Vec<LayerCache>> {
