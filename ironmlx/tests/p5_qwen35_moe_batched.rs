...
//! path as dense Qwen3.5 (see b1_p2_1_batched_prefill.rs for dense baseline).
...
//!     cargo test -p ironmlx --release --test p5_qwen35_moe_batched \
//!       -- --ignored --nocapture --test-threads=1

use mlx::Dtype;

/// Logits tolerance matching the dense Qwen3.5 hybrid-linear-attention drift
/// envelope (see b1_p2_1_batched_prefill.rs: LOGITS_TOL = 1.0).
