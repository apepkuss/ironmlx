...
use {
    crate::server::chat_format::render_and_encode, crate::server::chat_format::ChatFunctionCall,
    crate::server::chat_format::ChatMessage, crate::server::chat_format::ChatToolCall,
    crate::server::chat_format::Content, crate::server::chat_format::ContentPart,
    crate::server::chat_format::ImageUrl,
};
use {
    ironmlx_lm::core::generated_output::GeneratedFinishReason,
...
#[cfg(test)]
use {ironmlx_lm::core::vision_input::DecodedMessage, ironmlx_lm::core::vision_input::DecodedPart};

use super::api_transport::ApiJson;
use super::{AppState, Gemma4DrafterAppState, RequestAdmissionError};
use ironmlx_runtime::core::runtime_config::SamplingDefaults;
...
async fn admit_tool_request<M>(
    ...
    mpsc::UnboundedReceiver<ironmlx_runtime::core::scheduler::StepEvent>,
    Response,
>
where
    M: Model + DenseVlMethods + Send + 'static,
...
mod tests {
    ...
    fn anthropic_adapter_rejects_unmapped_typed_output() {
        ...
        let error = collect_tool_events(
            ...
            vec![GeneratedOutputEvent::AudioDelta(
                ironmlx_lm::core::generated_output::AudioChunk {
                    data: vec![1],
    ...
    async fn cold_materialization_rejection_is_retryable_http_503() {
        let error = ironmlx_runtime::core::scheduler::SchedulerError::ColdMaterializationUnsafe {
    ...
    mod wire_tests {
        ...
        fn validates_thinking_budget_effort_and_display_contracts() {
            ...
            assert!(matches!(
                ...
                Some(crate::server::openai::ChatResponseFormat::JsonSchema { .. })
            ));
        ...
        fn stream_encoder_enforces_required_and_serial_choices() {
            let required = ToolConstraintOptions {
                choice: ironmlx_lm::core::constrained::ToolChoiceConstraint::Required,
            ...
            let serial = ToolConstraintOptions {
                choice: ironmlx_lm::core::constrained::ToolChoiceConstraint::Auto,
...
mod parity_tests {
    use super::*;
    use crate::server::openai::decode_openai_messages;
    use crate::server::vision::expand_decoded_messages;
    use base64::Engine;
    ...
    async fn byte_parity_gemma4() {
        ...
        let loader =
            ironmlx_lm::core::loader::Loader::open_multimodal(&dir).expect("open_multimodal");
        let vc = ironmlx_lm::models::gemma4::Gemma4Config::from_loader(&loader)
