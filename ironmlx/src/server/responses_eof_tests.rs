...
use ironmlx_runtime::core::scheduler_actor::test_support::SchedulerActorFakeModel;
use ironmlx_runtime::core::scheduler_autotune::*;
use tower::ServiceExt;
use {ironmlx_runtime::core::scheduler::RequestId, ironmlx_runtime::core::scheduler::StepEvent};
...
async fn state() -> AppState<SchedulerActorFakeModel> {
    ...
    let tokenizer =
        ironmlx_lm::core::tokenizer::Tokenizer::from_files(&tokenizer_path, &config).unwrap();
