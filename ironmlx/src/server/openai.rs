...
use crate::server::structured_output::StructuredOutputFormat;
use ironmlx_core::sampler::Sampler;
use ironmlx_lm::core::image_input::ImageInputError;
...
use {
    crate::server::chat_format::ChatMessage, crate::server::chat_format::Content,
    crate::server::chat_format::ContentPart,
};
use {
    crate::server::vision::expand_decoded_messages_bounded,
    ironmlx_lm::core::vision_input::DecodedMessage, ironmlx_lm::core::vision_input::DecodedPart,
};
use {
    ironmlx_lm::core::constrained::ToolChoiceConstraint,
    ironmlx_lm::core::constrained::ToolConstraintOptions,
};
use {
    ironmlx_lm::core::generated_output::GeneratedOutputDecoder,
    ironmlx_lm::core::generated_output::GeneratedOutputEvent,
    ironmlx_lm::core::generated_output::ToolOutputDecoderConfig,
};
use {
    ironmlx_lm::core::tool_calling::lower_gemma_tool_arguments,
    ironmlx_lm::core::tool_calling::lower_gemma_tool_definitions,
    ironmlx_lm::core::tool_calling::validate_function_name,
    ironmlx_lm::core::tool_calling::validate_tool_definitions,
    ironmlx_lm::core::tool_calling::AgentMessage, ironmlx_lm::core::tool_calling::TemplateToolCall,
    ironmlx_lm::core::tool_calling::ToolCall, ironmlx_lm::core::tool_calling::ToolDefinition,
    ironmlx_lm::core::tool_calling::ToolDialect,
};

use super::api_transport::ApiJson;
use {
    super::AppState, super::Gemma4DrafterAppState, super::RequestAdmissionError,
...
pub(crate) fn compile_output_constraint_with_native(
    tokenizer: &ironmlx_lm::core::tokenizer::Tokenizer,
    ...
    M: Model + DenseVlMethods + Send + 'static,
{
    ...
    let (image_token_id, spatial_merge_size) =
        ironmlx_lm::core::vision_input::derive_image_token_and_merge(
            &state.vision_input,
            &state.tokenizer,
        );
...
pub(crate) async fn chat_completions_with_gemma4_drafter_state(
    ...
    if total_tokens > state.base.effective_cap_max {
        let error = ironmlx_runtime::core::scheduler::SchedulerError::RequestTooLarge {
...
mod tests {
    ...
    async fn text_only_image_is_rejected_before_data_url_decoding() {
        let error = expand_image_parts_in_messages(
            vec![ChatMessage {
                ...
                content: Content::Parts(vec![ContentPart::ImageUrl {
                    image_url: crate::server::chat_format::ImageUrl {
        ...
        assert_eq!(
            crate::server::image_input::image_error_status(ImageInputError::ModelUnsupported),
    ...
    fn build_sampler_uses_model_defaults_when_request_omits_sampling_params() {
        ...
        .expect("chat request");
        let defaults = ironmlx_runtime::core::runtime_config::SamplingDefaults {
    ...
    async fn admit_err_503_for_queue_full() {
        ...
        let err = anyhow::Error::new(
            ironmlx_runtime::core::scheduler::SchedulerError::QueueFull { capacity: 32 },
        );
    ...
    async fn admit_err_413_for_request_too_large() {
        ...
        let err = anyhow::Error::new(
            ironmlx_runtime::core::scheduler::SchedulerError::RequestTooLarge {
    ...
    fn admit_err_503_for_memory_budget_exceeded() {
        ...
        let err: anyhow::Error =
            ironmlx_runtime::core::scheduler::SchedulerError::MemoryBudgetExceeded {
    ...
    fn memory_governor_rejections_are_retryable_http_503() {
        let errors = [
            ironmlx_runtime::core::scheduler::SchedulerError::MemoryPressure {
                level: ironmlx_runtime::core::process_memory::PressureLevel::Hard,
                current_bytes: 95,
                ceiling_bytes: 100,
            },
            ironmlx_runtime::core::scheduler::SchedulerError::PrefillPeakUnsafe {
                requested_tokens: 4096,
                selected_tokens: 0,
                target_bytes: 100,
            },
            ironmlx_runtime::core::scheduler::SchedulerError::ColdMaterializationUnsafe {
                requested_bytes: 3 * 1024 * 1024 * 1024,
                current_bytes: 20 * 1024 * 1024 * 1024,
                target_bytes: 22 * 1024 * 1024 * 1024,
            },
            ironmlx_runtime::core::scheduler::SchedulerError::StoreBackpressure {
                pending_jobs: 4,
    ...
    fn minicpmv46_placeholder_format() {
        ...
        assert_eq!(
            ironmlx_lm::models::minicpmv4_6::image_placeholder_string(3),
