...
use {
    ironmlx_runtime::core::scheduler_actor::test_support::mk_req,
    ironmlx_runtime::core::scheduler_actor::test_support::wait_for_scheduler_resources_to_be_released,
    ironmlx_runtime::core::scheduler_actor::test_support::SchedulerActorFakeModel,
};
...
async fn scheduler_disconnect_contract_stream(
    ...
    let (tx, rx, disconnect) = crate::server::api_transport::disconnect_aware_sse_channel(2);
    ...
    tokio::spawn(async move {
        ...
        while let Some(event) =
            crate::server::api_transport::recv_or_disconnect(&disconnect, &mut event_rx).await
        {
    ...
    crate::server::api_transport::disconnect_aware_sse_response(rx)
}
