...
use anyhow::Context;
use std::path::Path;
pub(crate) const MTP_BASE_MODEL_NOT_FOUND_CODE: &str = "mtp_base_model_not_found";
pub(crate) const MTP_INCOMPATIBLE_CODE: &str = "mtp_incompatible";
pub(crate) const MTP_INVALID_CONFIG_CODE: &str = "mtp_invalid_config";
pub(crate) const MTP_INVALID_DRAFT_TOKENS_CODE: &str = "mtp_invalid_draft_tokens";
pub(crate) const MTP_INVALID_MODEL_TYPE_CODE: &str = "mtp_invalid_model_type";
pub(crate) const MTP_MODEL_NOT_FOUND_CODE: &str = "mtp_model_not_found";
pub(crate) const MTP_OK_CODE: &str = "ok";
pub(crate) const MTP_UNSUPPORTED_ARCHITECTURE_CODE: &str = "mtp_unsupported_architecture";
#[derive(Debug)]
pub(crate) struct MtpCompatibility {
    pub(crate) compatible: bool,
    pub(crate) reason_code: &'static str,
    pub(crate) message: String,
    pub(crate) draft_tokens: Option<usize>,
}
...
pub(crate) fn read_config_json(model_dir: &Path) -> Result<serde_json::Value> {
