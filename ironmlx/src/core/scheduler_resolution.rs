...
pub(crate) const DEFAULT_MAX_CACHE_CAP: usize = 32768;
pub(crate) const DEFAULT_DECODE_CADENCE_MID_CHUNK_CAP: usize = 256;
pub(crate) const BYTES_PER_GIB: usize = 1024 * 1024 * 1024;
#[derive(Debug, Clone)]
pub(crate) struct SchedulerResolutionOptions {
    pub(crate) prefill_chunk_size: Option<usize>,
    pub(crate) b_max: Option<usize>,
    pub(crate) admission_deadline_ms: Option<u64>,
    pub(crate) admission_queue_max: Option<usize>,
    pub(crate) max_cache_cap: Option<usize>,
    pub(crate) decode_cadence_mid_chunk_cap: Option<usize>,
    pub(crate) scheduler_profile: Option<PathBuf>,
...
#[derive(Debug)]
pub(crate) struct SchedulerProfileLoad {
    pub(crate) path: PathBuf,
    pub(crate) profile: SchedulerAutotuneRuntimeProfile,
    pub(crate) auto_loaded: bool,
}
...
pub(crate) fn default_scheduler_runtime_profile(
...
pub(crate) fn load_scheduler_profile_for_model(
    args: &SchedulerResolutionOptions,
    model_dir: &Path,
...
pub(crate) fn load_scheduler_profile_for_model_with_explicit(
...
pub(crate) fn check_loaded_scheduler_profile_health(
...
pub(crate) fn log_scheduler_profile_health(
    profile_path: &Path,
...
pub(crate) fn scheduler_profile_model_name(model_dir: &Path) -> Result<String> {
    model_dir
        .file_name()
...
pub(crate) fn scheduler_runtime_context_for_model(
    args: &SchedulerResolutionOptions,
    model_dir: &Path,
...
pub(crate) fn resolve_scheduler_runtime_profile(
    args: &SchedulerResolutionOptions,
...
pub(crate) fn resolve_ssd_prefix_cache_max_bytes(
    args: &SchedulerResolutionOptions,
) -> Result<Option<usize>> {
