...
pub(crate) enum EngineUnloadReason {
    Startup,
    Evicted,
    Manual,
    Ttl,
...
impl EngineLease {
    ...
    pub(crate) fn engine(&self) -> &EngineVariant {
        &self.engine
    }
}
...
impl EnginePoolState {
    ...
    pub(crate) async fn unload_model(&self, requested: &str) -> Result<EngineModelControlResult> {
        let model_id = self
            .inner
            .registry
            .lock()
    ...
    pub(crate) async fn model_snapshots(&self) -> Vec<EngineModelSnapshot> {
    ...
    pub(crate) async fn health_snapshot(&self) -> EnginePoolHealth {
        let mut models = Vec::new();
...
#[derive(Debug, Serialize)]
pub(crate) struct EnginePoolHealth {
...
#[derive(Debug, Serialize)]
pub(crate) struct EngineModelSnapshot {
    pub(crate) id: String,
    pub(crate) load_policy: EngineLoadPolicy,
    pub(crate) state: EngineRuntimeState,
    pub(crate) unload_reason: Option<EngineUnloadReason>,
    pub(crate) last_error: Option<String>,
    pub(crate) changed_unix_ms: Option<u64>,
    pub(crate) load_started_unix_ms: Option<u64>,
    pub(crate) loaded_unix_ms: Option<u64>,
    pub(crate) last_used_unix_ms: Option<u64>,
    pub(crate) failed_unix_ms: Option<u64>,
