...
pub(crate) fn validate_mtp_pair(
    ...
    crate::core::model_validation::validate_mtp_pair(model_dir, mtp_model_dir, draft_tokens)
        .map(Into::into)
}
...
fn aggregate_health(start_time: Instant, snapshots: Vec<HealthSnapshot>) -> HealthSnapshot {
    ...
    let mut immutable_prefix_blocks =
        crate::core::scheduler_actor::ImmutablePrefixBlockHealth::default();
...
mod tests {
    ...
    fn per_model_max_cache_cap_overrides_scheduler_config_and_rules() {
        let resolved = ResolvedSchedulerRuntime {
            scheduler_config: crate::core::scheduler_resolution::SchedulerServeConfig {
                max_cache_cap: 32768,
                ..Default::default()
            },
...
use crate::core::model_validation::{
    MTP_BASE_MODEL_NOT_FOUND_CODE, MTP_INCOMPATIBLE_CODE, MTP_INVALID_CONFIG_CODE,
    MTP_INVALID_DRAFT_TOKENS_CODE, MTP_INVALID_MODEL_TYPE_CODE, MTP_MODEL_NOT_FOUND_CODE,
    MTP_UNSUPPORTED_ARCHITECTURE_CODE,
};

impl From<crate::core::model_validation::MtpCompatibility> for MtpValidationResponse {
    fn from(value: crate::core::model_validation::MtpCompatibility) -> Self {
        Self {
...
#[cfg(test)]
use crate::core::model_validation::MTP_OK_CODE;
