...
export REPO="$REPO"
export RIVALS_DIR="$RIVALS_DIR"
export IRONMLX_MOE_MODEL_DIR="$IRONMLX_MOE_MODEL_DIR"
export QWEN35_MODEL="$QWEN35_MODEL"
...
- `/tmp/p5g-env.sh` written; cat output shows the 5 `export` lines.
